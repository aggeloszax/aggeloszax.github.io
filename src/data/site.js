export const site = {
  ...
  hero: {
    headline: "I'm Aggelos Zaxariou",
    tagline: [
      {
        text: "DSIS Student at UniPi",
        href: "https://unipi.gr",
      },
      {
        text: "Statistics Specialist at Basketaki The League",
        href: "https://basketaki.com",
      },
    ],
    image: {
  ...
  about: {
    ...
    highlights: [
      ...
      "Driven by: Accuracy, Consistency, Analytics",
    ],
  },
  projects: {
    title: "Projects",
    ...
    items: [
      {
        ...
        description: "Certification details will be added soon.",
  ...
  languages: {
    title: "Languages & Working Status",
    logos: [
      {
  ...
  contact: {
    ...
    subtitle: "Let's Work Together. Contact me.",
    phone: {
      label: "Phone number",
      value: "6906270337",
